...
IaaP Guard is the completed, bounded GitHub-native architecture and evidence product produced by this Infrastructure-as-a-Product program. The supported V1 release is [`v1.0.2`](https://github.com/SAABOLImpactVenture/iaap-guard/releases/tag/v1.0.2).
