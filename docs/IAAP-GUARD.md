...
IaaP Guard is the completed, bounded GitHub-native architecture and evidence product produced by this Infrastructure-as-a-Product program. The supported V1 release is [`v1.0.2`](https://github.com/InfrastructureProductWorks/iaap-guard/releases/tag/v1.0.2).

## Install and operate

- **App page:** https://github.com/apps/iaap-guard
- **Direct install:** https://github.com/apps/iaap-guard/installations/new
- **Product repository:** https://github.com/InfrastructureProductWorks/iaap-guard
- **Support policy:** https://github.com/InfrastructureProductWorks/iaap-guard/blob/v1.0.2/docs/SUPPORT.md
- **Upgrade and rollback:** https://github.com/InfrastructureProductWorks/iaap-guard/blob/v1.0.0/docs/UPGRADING.md
- **Known limits:** https://github.com/InfrastructureProductWorks/iaap-guard/blob/v1.0.2/docs/KNOWN-LIMITS.md
- **Frozen V1 contract:** https://github.com/InfrastructureProductWorks/iaap-guard/blob/v1.0.2/docs/V1-CONTRACT-FREEZE.md
- **Final validation:** https://github.com/InfrastructureProductWorks/iaap-guard/blob/v1.0.2/docs/PHASE-18-VALIDATION.md
